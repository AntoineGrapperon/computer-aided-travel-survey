...
- [x] **Survey Customization:** Allow administrators to define available travel modes and trip purposes.
...
- [x] **Public Transport Integration:** Linking reported transit trips with GTFS data for more granular analysis.
